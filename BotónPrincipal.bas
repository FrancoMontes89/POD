...
'Control ortográfico:
If Área_Impresión.CheckSpelling = True Then
    ...
    Call ADO.AbrirConexiónLista
        ...
        Do While cont < ncampos
            ...
            rst.AddNew
                rst.Fields("Rol") = HojaOrigen.Cells(preal_campo1 + cont, 2).Value
                rst.Fields("Modo de trabajo") = HojaOrigen.Cells(preal_campo1 + cont, 3).Value
                rst.Fields("Nombre") = HojaOrigen.Cells(preal_campo1 + cont, 5).Value
                rst.Fields("Inicio") = Int(HojaOrigen.Cells(preal_campo1 + cont, 7).Value * 1440)
                rst.Fields("Fin") = Int(HojaOrigen.Cells(preal_campo1 + cont, 9).Value * 1440)
...
4:
    ...
    MsgBox "Copiada tabla 4, 3 no se copia"

...
p_proximotítulo = 0 'Application.WorksheetFunction.VLookup(ntabla + 1, Sheets(2).Range("Q1:V13"), 3, False)
p_enunciado = 0 'Application.WorksheetFunction.VLookup(ntabla, Sheets(2).Range("Q1:V13"), 4, False)
p_campo1 = 1 ' Application.WorksheetFunction.VLookup(ntabla, Sheets(2).Range("Q1:V13"), 5, False)
...
NombreLista = "FIAMBALÁ_Personal"
query = "SELECT * FROM [" & NombreLista & "];"
GUID = "49e29747-ee21-4f4e-a80c-0a1ca50b72b7"
...
rst.Open query, conn, adOpenDynamic, adLockOptimistic
    ...
    Do While cont < ncampos
        ...
        rst.AddNew
            ...
            rst!Inicio = HojaOrigen.Cells(preal_campo1 + cont, 7).Value
            rst!Fin = HojaOrigen.Cells(preal_campo1 + cont, 9).Value
            rst!Fecha = FechaPOD
        rst.Update
